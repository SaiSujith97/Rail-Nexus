...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ text }) => {
    return (
        <div className="flex flex-col items-center justify-center p-8 bg-white/75 dark:bg-gray-800/75 rounded-lg">
            ...
            <p className="mt-4 text-xl font-semibold text-gray-900 dark:text-white">{text}</p>
        </div>
    );
};
